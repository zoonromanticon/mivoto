...
export class ToggleButtonGroupControlled extends React.Component {
    ...
    render() {
      return (
        ...
        >
          <ToggleButton className="grow" bsSize="large" style={{fontFamily:'monospace', fontSize:'180%'}} bsStyle="info" value={1}> Totalmente de acuerdo</ToggleButton>
          <ToggleButton className="grow" bsSize="large" style={{fontFamily:'monospace', fontSize:'180%'}} bsStyle="primary" value={2}> De acuerdo</ToggleButton>
